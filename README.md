...
1.  **Clone the repo:**
    ```bash
    git clone https://github.com/rychanroth/FoodFlow.git
    ```
...
## Details
For further detail, you can read the full documentation of the project.
[FoodFlow-AUB-B9Y2S2-Andriod-Project-Report.pdf](https://github.com/user-attachments/files/28837354/FoodFlow-AUB-B9Y2S2-Andriod-Project-Report.pdf)
